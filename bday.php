<?php session_start();
$user_token = $_SESSION['admin_token'];
...
<canvas class="animate__animated animate__fadeIn" height='1' id='confetti' width='1'></canvas>
      ...
      <?php  $email_mess="";
        if(isset($_POST['date'])){
            ...
            $db = new Database;
                 ...
                 $db->execute("UPDATE `admins` SET `date`='$date' WHERE `user_token`='$user_token'"); 
                 $email_mess="";
    ...
    ?>
        ...
        <h1 class="h3 mb-3 fw-normal intro animate__animated animate__fadeInUp"><b>Когда твой день рождения?</b><br>

    
        <div class="form-floating animate__animated animate__fadeInUp">
            <input type="date" name="date" id="date" class="form-control animate__animated animate__fadeInUp"  placeholder="date">
            <label for="date"><i class="fa-solid fa-envelope animate__animated animate__fadeInUp"></i><span class="label">Дата рождения..</span></label>
        </div>
