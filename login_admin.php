...
<canvas class="animate__animated animate__fadeIn" height='1' id='confetti' width='1'></canvas>
    ...
    ?>
        ...
        <h1 class="h3 mb-3 fw-normal intro animate__animated animate__fadeInUp"><b>Добро пожаловать Именинник!</b><br>
        ...
        <div class="form-floating animate__animated animate__fadeInUp">
            <input type="password" name="password" id="password" class="form-control animate__animated animate__fadeInUp"  placeholder="Password">
            <label for="password"><i class="fa-solid fa-envelope animate__animated animate__fadeInUp"></i><span class="label">Пароль</span></label>
        </div>

        <button class="w-100 btn btn-lg btn-primary animate__animated animate__fadeInUp" type="submit">Зарегестрироваться</button>
        <div><?=$email_mess;?></div>
        <p class="mt-5 mb-3 text-muted animate__animated animate__fadeInUp">Или <a href="">Войти</a></p>
