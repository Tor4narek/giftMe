...
<main class="form-signin w-100 m-auto animate__animated animate__fadeInUp">
  ...
  <?php  $email_mess="";
    ...
    <h1 class="h3 mb-3 fw-normal intro animate__animated animate__fadeInUp"><b>GiftMe</b><br><p class="description animate__animated animate__fadeInUp">Введите ваш <b>E-Mail</b>, придумайте <b>пароль</b> и укажите <b>PartyID</b>(узнайте у автора праздника) или перейдите по ссылке, которую пришлет организатор!</p></h1>
